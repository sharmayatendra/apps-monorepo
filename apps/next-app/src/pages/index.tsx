...
import { Button } from '@apps-monorepo/design-system/Button'
    ...
    >
      ...
      >
        <p
          ...
          border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-
          2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit 
