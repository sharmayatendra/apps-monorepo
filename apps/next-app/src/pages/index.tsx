...
export default function Home() {
  return (
    ...
    >
      ...
      >
        <p
          className="backdrop-blur- 2xl fixed left-0 top-0 flex w-full
          justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6
          pt-8 dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit
      ...
      <div
        className="before:bg-gradient-radial after:bg-gradient-conic relative flex
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        <a
          href="https://nextjs.org/docs?utm_source=create-next-app&utm_medium=
          default-template-tw&utm_campaign=create-next-app"
        ...
        <a
          href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=
          default-template-tw&utm_campaign=create-next-app"
          className="group rounded-lg border border-transparent px-5 py-4
          transition-colors hover:border-gray-300 hover:bg-gray-100
          hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
        ...
        >
          <h2 className="mb-3 text-2xl font-semibold">
            Learn
            <span
              className="group-hover: inline-block translate-x-1
